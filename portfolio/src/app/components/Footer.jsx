...
export default function Footer({ ES }) {
  ...
  return (
    <article className="flex flex-col items-center bg-[#4F76C1] gap-1 p-2">
      ...
      <div className="flex gap-4">
        ...
        <button onMouseEnter={()=>setOnButton(true)} onMouseLeave={()=>setOnButton(false)} className="flex items-center">
            <animated.p style={animacion3} className="text-xs absolute p-0.5 rounded bg-slate-400 ml-5">+54 3571-533276</animated.p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-5 w-5"
          fill="currentColor"
